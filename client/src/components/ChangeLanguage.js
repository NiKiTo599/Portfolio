...
export default class ChangeLanguage extends React.Component {
  constructor(props) {
    ...
    this.currLang = "en";
    this.en =
      "container-change_language__button container-change_language__button__active";
    this.ru = "container-change_language__button";
  }
  changeLang = (lng) => {
    if (this.currLang !== lng) {
      let r = null;
      r = this.en;
      this.en = this.ru;
      this.ru = r;
  ...
  render() {
    return (
      <div className="container-change_language">
        <button
          className={`fadeInLeft wow ${this.en}`}
          onClick={this.changeLang.bind(this, "en")}
        >
          en
        </button>
        <button
          className={`fadeInRight wow ${this.ru}`}
          onClick={this.changeLang.bind(this, "ru")}
        >
          ru
        </button>
      </div>
